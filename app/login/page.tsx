  ...
  return (
    <main className="flex min-h-screen bg-surface">
      ...
      <section className="flex flex-1 items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full max-w-md rounded-lg border border-hairline bg-canvas p-6 shadow-soft sm:p-8">
          <Link href="/" className="mb-8 flex items-center gap-3 lg:hidden">
            <SchoolLogo school={school} />
            <span className="text-base font-semibold text-ink">{schoolName}</span>
          </Link>
          <div className="flex h-12 w-12 items-center justify-center rounded-md bg-surface text-brand-orange">
            <LockKeyhole className="h-6 w-6" aria-hidden="true" />
          </div>
          <h2 className="mt-5 text-2xl font-semibold text-ink">School Login</h2>
          <p className="mt-2 text-sm leading-6 text-slate">Sign in with the account provided by your school administrator.</p>
          ...
          <p className="mt-6 text-center text-sm text-slate">
            Need access?{" "}
            <a href="mailto:hello@refugeeschoolos.org" className="font-semibold text-brand-orange hover:text-ink">
              Request a demo
            </a>
          </p>
        </div>
