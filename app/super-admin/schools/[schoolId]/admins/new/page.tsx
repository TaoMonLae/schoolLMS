  ...
  return (
    <div className="mx-auto max-w-xl space-y-6">
      ...
      <form
        ...
        className="space-y-5 rounded-lg border border-line bg-white p-6 shadow-soft"
      >
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-semibold text-ink">
            Temporary Password <span className="text-clay">*</span>
          </label>
          <input
            id="password"
            name="password"
        ...
        <div className="rounded-md border border-line bg-rice p-4">
          ...
          <p className="mt-1 text-xs text-moss">
            ...
            <code className="rounded bg-white px-1">{schoolId}</code> and will only ever see data
