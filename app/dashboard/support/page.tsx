      ...
      <section className="grid gap-4 lg:grid-cols-[320px_1fr]">
        <aside className="rounded-lg border border-hairline bg-canvas p-4 shadow-soft">
          ...
          <form className="mt-4">
            ...
            <button className="mt-3 w-full rounded-md bg-ink px-4 py-2 text-sm font-bold text-on-dark">Open Student</button>
          </form>
      ...
      <section className="rounded-lg border border-hairline bg-canvas p-5 shadow-soft">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          {(canManageSupport(user.role) || canAddBasic) ? (
            <Link href={`/dashboard/support/new?studentId=${student.id}`} className="inline-flex items-center justify-center gap-2 rounded-md bg-ink px-4 py-3 text-sm font-bold text-on-dark">
              ...
              {!note.redacted && (note.sensitivity === "BASIC" ? canAddBasic : canAddSensitive) ? (
                <details className="mt-3 rounded-md border border-hairline bg-canvas p-3">
                  ...
                  <form action={updateCaseNote} className="mt-3 grid gap-2">
                    ...
                    <button className="rounded-md bg-ink px-3 py-2 text-xs font-bold text-on-dark">Update note</button>
                  </form>
